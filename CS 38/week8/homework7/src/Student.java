...
/**
* Description
* student data encapsulating object that simplifies interaction with data arrays from files
* 
...
public class Student {
     ...
     /**Reads student data from a file with the given path and returns a list of Student objects**/
